...
public class TokenizerTest {
    ...
    public void testTokenizeContent() {
        ...
        expectedTokens.addAll(Arrays.asList(tokens));
    ...
    public void testTokenizeAllDocuments() {
        ...
        Set<String> expectedTokensOfDoc1 = new HashSet<>(Arrays.asList(new String[] {"hello", "test", "tokenizer"}));
        assertEquals(expectedTokensOfDoc1, firstDocTokens);

        Set<String> secondDocTokens = document2.getTokenizedWords();
        Set<String> expectedTokensOfDoc2 = new HashSet<>(Arrays.asList(new String[] {"this", "is", "second", "doc"}));
